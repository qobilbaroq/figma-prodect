...
const Header = () => {
  return (
    <nav
      className="flex justify-between items-center h-[65px] w-full m-3 p-5 bg-slate-200 rounded-lg"
    ...
    >
      ...
      <div className="flex gap-7 font-mono items-center">
        ...
        <div className="bg-blue-500 p-2 rounded-xl text-white text-2xl flex items-center justify-center cursor-pointer hover:bg-blue-600"><RiShoppingBasketLine/></div>
      </div>
    </nav>
  );
};
